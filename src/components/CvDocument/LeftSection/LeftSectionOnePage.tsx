// LeftSectionOnePage.tsx
// This component renders a more compact left section specifically for the one-page CV.
// It's similar to LeftSection but with reduced vertical spacing to ensure everything fits on one page.
//
// Main sections:
// - Profile picture (with reduced margins)
// - Contact information (essential items only)
// - Skills list (with the most important skills)
// - Education details
//
// Key differences from the standard LeftSection:
// - Reduced vertical margins between elements
// - Smaller profile picture
// - More compact skill list focusing on most relevant skills
//
// Usage: Used as part of the CvDocumentOnePage layout.
...
const LeftSectionOnePage = () => {
  return (
    ...
    icon={(
      ...
      <LeftSectionPanel title="Education" titleColor="#42C7E5">
...
const styles = StyleSheet.create({
  ...
  profilePictureContainer: {
    width: '80%', // Smaller than in the main layout
    marginHorizontal: 'auto',
    marginBottom: 10  // Reduced margin
  },
  profilePicture: {
    borderRadius: 9999,
    transform: 'translateY(8px)', // Smaller offset
  },
});

export default LeftSectionOnePage;
