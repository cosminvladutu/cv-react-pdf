    ...
    <View style={containerStyle}>
      {!hideHeader && (
        <>          <View style={styles.header}>
          ...
          <Text style={styles.aboutMeDescription}>I am a Microsoft MVP and certified (MCSD and Azure) Senior .NET lead / architect / developer / contractor / freelancer with <Text style={{fontWeight: 'black'}}>14+ years of experience</Text>. . My expertise lies in both front-end and back-end development, and I 
